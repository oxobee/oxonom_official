...
export const pricing = {
  ...
  voice: [
    {
      ...
      pricePerMin: '',
      totalPrice: '$69',
      upsell: 'Standart paketine geçerek 3x daha fazla dakika kazanın',
      popular: false,
    ...
    },
    {
      ...
      pricePerMin: '',
      totalPrice: '$169',
      upsell: 'Pro paketine geçerek 2.7x daha fazla dakika kazanın',
      popular: true,
    ...
    },
    {
      ...
      pricePerMin: '',
      totalPrice: '$399',
      upsell: 'Scale paketine geçerek 2.5x daha fazla dakika kazanın',
      popular: false,
  ...
  messaging: [
    ...
    },
    {
      ...
      price: '$699',
      perMsg: '',
      upsell: 'Business paketine geçerek 3.75x daha fazla mesaj kazanın',
      popular: false,
  ...
  combo: [
    ...
    },
    {
      ...
      minutes: '800',
      messages: '20.000',
      saving: '$199 tasarruf (%18)',
      originalPrice: '$1.098',
      upsell: 'Combo Scale → 2.5x ses, 3.75x mesaj kapasitesi',
      popular: false,
      channels: ['instagram', 'whatsapp', 'facebook', 'web', 'tiktok'],
      features: [
