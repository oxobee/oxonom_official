                    ...
                    <div className="grid grid-cols-12 gap-2 p-2 pt-0">
                      <div className="col-span-12 md:col-span-8">
                        <Link
                          to="/instagram"
                          onClick={() => setIsProductMegaMenuOpen(false)}
                          className="group relative overflow-hidden rounded-xl p-7 bg-gradient-to-br from-pink-50 to-orange-50 border border-pink-100 hover:border-brand/30 transition-all premium-shadow premium-shadow-hover"
                        >
                          ...
                          <div className="relative z-10 flex items-start gap-4">
                            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-pink-500 to-orange-500 text-white flex items-center justify-center shadow-lg shadow-pink-500/20">
                      ...
                      <div className="col-span-12 md:col-span-4 rounded-xl bg-dark text-white border border-gray-800 overflow-hidden relative">
                                ...
                                <div className="space-y-2 mb-6">
                                  {slide.bullets.map((t) => (
                                    <div key={t} className="flex items-start gap-2">
                                      <div className="w-5 h-5 rounded-lg bg-white/10 border border-white/15 flex items-center justify-center shrink-0 mt-0.5">
